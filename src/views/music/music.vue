<template>
  <div class="movie-details">
    <div class="logo-w">
      ...
      <input type="text" placeholder="搜索豆瓣音乐" class="input" @input="inputSearch" v-model.trim="keyWords">
        ...
        <ul class="comments-d-uls">
          <li v-for="(item) in commentsData" :key="item.id" class="comments-d-list" @click="gotoDetails(item.id)">
            ...
            <div class="right">
              ...
              <p class="name-w">{{getGenres(item.author)}}</p>
